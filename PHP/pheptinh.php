...
<form action="" method="POST">
 <table>
     <tr><td colspan="5" ><center>Tính tổng 2 số nguyên </center></td></tr>
     <tr>
    ...
    <tr>
      <td>Kết quả</td>
      <td colspan="4"><input type="text" name="ketqua" readonly  value="<?php if(isset($_POST["submit"])&&isset($_POST["so1"])&&isset($_POST["so2"])&&isset($_POST["pt"])){ echo ($Resuft);}?>"> </td>
   </tr>
   <tr><td colspan="5"> <center> <input type="submit" name="submit" value="Kiểm tra" ></center></td></tr>
 </table>
</form>
</body>
</html>
